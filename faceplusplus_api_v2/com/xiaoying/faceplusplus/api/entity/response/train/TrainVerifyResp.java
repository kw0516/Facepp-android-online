...
/**
 * 功能：TrainVerify请求返回实体类
 * @author xiaoying
 *
 */
public class TrainVerifyResp extends BaseResponse {
	...
	public String toString() {
		return "TrainVerifyResp [session_id=" + session_id + ", error=" + error
